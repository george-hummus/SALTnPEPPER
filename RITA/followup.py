...
#check if requests for today have already been made
if len(glob.glob(f"../xOUTPUTS/requests_{now.strftime('%Y%m%d')}.json")) != 0:
    print("Requests to LT have already been made today.")
